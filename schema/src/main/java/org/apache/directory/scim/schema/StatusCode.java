...
public enum StatusCode
{
    ...
    PERMANENT_REDIRECT(308, "The client is directed to repeat the same HTTP request at the location identified. The client"
    ...
    CONFLICT(409, "The specified version number does not match the resource's latest version number or a Service Provider refused"
